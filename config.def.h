...
static const char *colors[][3]      = {
	...
	[SchemeHid] = { col_gray4, col_gray3, col_gray2 },
...
static const Rule rules[] = {
	...
	{ "teams-for-linux",  NULL,       NULL,       4,            0,            0 },
};
...
static const char *tmuxcmd[]  = { "kitty", "-e", "tmux", "a", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_m,      togglemaximize, {.v = &layouts[2]} },
    { MODKEY|ControlMask,           XK_m,      setlayout,      {0} },
    ...
    { ALTMOD|ShiftMask,             XK_p,         spawn,          {.v = passmenu} },
